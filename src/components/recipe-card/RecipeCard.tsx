    ...
    <>
      <Card
        ...
        <div className="recipe-card-details-container">
          <h3 className="recipe-title"><span className="recipe-title-leftovers">{recipe.archived ? "(Archived) " : ""}{recipe.updated ? "[Outdated] " : ""}{leftovers ? "Leftover " : ""}</span>{recipe.title}</h3>
