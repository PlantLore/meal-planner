...
const RecipeUpsertView = () => {
    ...
    return <div className='max-page-content recipe-upsert-container'>
        {!loading ? <RecipeUpsert initialFood={food} onSubmit={handleFoodUpsert}></RecipeUpsert> : <RecipeDisplaySkeleton />}
    </div>;
};
